...
namespace dlgt {
    ...
    *
    * \tparam T            class-type of the object who's member function to
    * call
    ...
    */
    ...
    public:
        ...
        delegate(func_type func, T& callee) : callee_(callee), func_(func)
        {
        }
    ...
    */
    ...
    public:
        ...
        delegate(func_type func, const T& callee) : callee_(callee), func_(func)
        {
        }
    ...
    */
    ...
    public:
        ...
        delegate(func_type func) : func_(func)
        {
        }
