...
// --------------------------------------------------------------- add_text ---
void set_text(vertex_buffer_t* buffer, texture_font_t* font, char* text,
              vec4* color, vec2* pen)
{
    ...
    while (i < strlen(text)) {
        ...
        if (glyph != NULL) {
            ...
            // texture atlas is full. enlarge it!
            i = -1;
            vertex_buffer_clear(buffer);
            texture_font_enlarge_atlas(font, font->atlas->width * 2,
                                       font->atlas->height * 2);
        }
        i++;
    }
...
void init(void)
{
    ...
    shader =
        shader_load("shaders/v3f-t2f-c4f.vert", "shaders/v3f-t2f-c4f.frag");
...
void display(GLFWwindow* window)
{
    ...
    glUseProgram(shader);
    {
        ...
        glUniformMatrix4fv(glGetUniformLocation(shader, "model"), 1, 0,
                           model.data);
        glUniformMatrix4fv(glGetUniformLocation(shader, "view"), 1, 0,
                           view.data);
