...
namespace ftgl {
    ...
    typedef struct texture_glyph_t {
        ...
        /**
         * For vertical text layouts, this is the vertical distance (in
         * fractional
    ...
    typedef struct texture_font_t {
        ...
        /**
         * This field is simply used to compute a default line spacing (i.e.,
         * the
         ...
         * the highest 'character' coordinate in a font face. Unfortunately,
         * font
         * formats define the ascender differently. For some, it represents the
         * ascent of all capital latin characters (without accents), for others
         * it
    ...
    /**
     * This function creates a new texture font from given filename and size.
     * The
     * texture atlas is used to store glyph on demand. Note the depth of the
     * atlas
     * will determine if the font is rendered as alpha channel only (depth = 1)
     * or
     * RGB (depth = 3) that correspond to subpixel rendering (if available on
     * your
    ...
    /**
     * Request a new glyph from the font. If it has not been created yet, it
     * will
     * be.
     *
     * @param self      A valid texture font
     ...
     *
     * @return A pointer on the new glyph or 0 if the glyph is not yet loaded
     */
     ...
     *
     * @param self       A valid texture font
     * @param codepoints Character codepoints to be loaded in UTF-8 encoding.
     * May
     *                   contain duplicates.
     *
